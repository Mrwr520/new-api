...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/epay/notify", anonymousRequestBodyLimit, controller.XunHuPayNotify)
			userRoute.GET("/epay/notify", controller.XunHuPayNotify)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/pay", middleware.CriticalRateLimit(), controller.RequestXunHuPay)
